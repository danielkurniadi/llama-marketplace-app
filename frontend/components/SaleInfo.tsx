...
import { Web3Button, useContract, useCreateAuctionListing } from "@thirdweb-dev/react";
...
import { useCreateDirectListing } from "../hooks/listings";
...
export default function SaleInfo({ nft }: Props) {
  ...
  const { register: registerDirect, handleSubmit: onSubmitDirect } = useForm<DirectFormData>({
    defaultValues: {
        ...
        <TabPanel>
          <Stack spacing={8}>
            ...
            <Web3Button
              ...
              action={async () => {
                await onSubmitDirect(handleSubmissionDirect)();
              }}
              onSuccess={(txResult) => {
